 ...
 */
const startVideoController = async (req, res) => {
 ...
 * End a livestream
 */
const endVideoController = async (req, res) => {
 ...
 */
const getStreamTokenController = async (req, res) => {
 ...
 */
const getAudienceTokenController = async (req, res) => {
...
module.exports = { startVideoController, endVideoController, getStreamTokenController, getAudienceTokenController }
